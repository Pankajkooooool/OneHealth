...
const Card = ({item}) => {
  ...
  <div className="flex-shrink-0 w-6 h-6 rounded-full  sm:mt-0 inline-flex items-center justify-center bg-sky-600 text-white relative z-1 title-font font-medium text-sm self-end cursor-pointer items-center -mr-8 -mt-1 " onClick={toggleExpansion}>&#9660;</div>

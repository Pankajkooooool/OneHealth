...
const Signin = ({isAuth,updateAuth}) => {
  ...
  const handleLogin = () => {
   ...
   if(Cpassword===password){
    handleLoginReq(email, password,UserName,Uid,dob,phone);
   }else{
  ...
  async function handleLoginReq(email, password,UserName,Uid,dob,phone) {
    ...
    const requestOptions = {
      ...
      body: JSON.stringify({ email, password,UserName,Uid,dob,phone }),
    };
